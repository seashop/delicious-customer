		...
		data() {
			return {
				...
				categories: [{
						...
						level: 1,
						number: 0,
						category_pic: '/preset/static/images/tj.jpg',
					},
					{
						category_name: '新品',
						category_id: 1002,
						level: 1,
						number: 0,
						category_pic: '/preset/static/images/xp.jpg',
					},
					{
						category_name: '热销',
						category_id: 1003,
						level: 1,
						number: 0,
						category_pic: '/preset/static/images/rx.jpg',
					},
					{
						category_name: '满减',
						category_id: 1004,
						level: 1,
						number: 0,
						category_pic: '/preset/static/images/hd.jpg',
					}
				],
				cart: [],
				productList: [],
